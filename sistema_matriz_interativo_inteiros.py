...
print('Agora você terá a chance de montar sua matriz e descobrir seu determinante, sua inversa e os devidos resultados das incógnitas.'
      '\nPara números inteiros com 3 incógnitas')
...
b11 = int(input('Digite o valor da primeira linha e primeira coluna (b11): '))
b21 = int(input('Digite o valor da segunda linha e primeira coluna (b21): '))
b31 = int(input('Digite o valor da terceira linha e primeira coluna (b31): '))
